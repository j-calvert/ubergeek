...
public abstract class Tracer extends MSPPerformer {
	JitterMatrix jm = new JitterMatrix();

	protected static final int[][] nbrs = new int[][] { { 1, 0 }, { 1, -1 },
	...
	protected abstract void getTraces(int w, int h, int[] data);
